...
function MailIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-[18px] fill-white" aria-hidden="true">
...
function LinkedInIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-[15px] fill-current" aria-hidden="true">
...
export function ContactCard() {
  return (
    <div className="grid w-full min-w-0 max-w-[840px] overflow-hidden rounded-[14px] bg-white shadow-[0_12px_48px_rgba(0,0,0,0.12)] transition-shadow duration-300 hover:shadow-[0_20px_64px_rgba(0,0,0,0.16)] max-[620px]:grid-cols-1 min-[621px]:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]">
      <div className="group relative min-h-[420px] min-w-0 overflow-hidden bg-brand-mid max-[620px]:min-h-[280px]">
        <Image
        ...
        <div className="absolute inset-x-0 bottom-0 z-2 w-full bg-[linear-gradient(transparent,rgba(26,37,47,0.9))] px-6 pt-10 pb-6 text-white">
          ...
          <p className="m-0 text-[0.82rem] tracking-[1.2px] text-accent uppercase">
      ...
      <div className="flex min-w-0 flex-col justify-center gap-8 px-10 py-12 max-[680px]:px-6 max-[680px]:py-8">
        <div>
          <h2 className="mb-1 font-serif text-[1.8rem] leading-tight font-bold tracking-normal text-brand-mid">
            Let&apos;s Connect
          </h2>
        ...
        <div className="flex flex-col gap-[1.1rem]">
          ...
          >
            <span className="flex size-[42px] shrink-0 items-center justify-center rounded-[10px] bg-brand-mid">
              <MailIcon />
            </span>
            <span className="flex flex-col">
              ...
              <span className="text-[0.95rem] font-medium break-words text-[#333]">{site.email}</span>
            </span>
          </a>
          <a
            href={site.phoneHref}
          ...
          >
            ...
            <span className="flex flex-col">
              ...
              <span className="text-[0.95rem] font-medium text-[#333]">{site.phoneDisplay}</span>
            </span>
          </a>
          <div className="flex items-center gap-4 rounded-lg px-3.5 py-2.5">
            ...
            <span className="flex flex-col">
              ...
              <span className="text-[0.95rem] font-medium text-[#333]">{site.location}</span>
            </span>
          </div>
        </div>
